...
$dominio = "http://localhost/repos_micamello";//"www.micamello.com.ec";
...
if(isset($_GET['id_empresa']) && !isset($_GET['estado'])){
	...
	echo '<button class="boton_personalizado" type="submit">Rechazar</button></form>';
	...
	$enlace = "<a href='".PUERTO."://".$dominio."/login/'>click aqu&iacute;</a><br>";      
