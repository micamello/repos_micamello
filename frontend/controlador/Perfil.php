    ...
    public function guardarPerfil($imagen, $archivo, $idUsuario,$tipo_usuario)
    {
        try {
            if ($tipo_usuario == Modelo_Usuario::CANDIDATO) {
                $campos = array('nombres' => 1, 'apellidos' => 1, 'ciudad' => 1, 'provincia' => 1, 'discapacidad' => 0, 'fecha_nacimiento' => 1, 'telefono' => 1, 'genero' => 1, 'escolaridad' => 1/*, 'area_select' => 1, 'nivel_interes' => 1*/, 'id_nacionalidad' => 1, 'licencia' => 0, 'viajar' => 0, 'tiene_trabajo' => 0, 'nivel_idioma'=>1,'lugar_estudio'=>0, 'universidad'=>0, 'universidad2'=>0,'residencia'=>1, 'convencional' => 0);
