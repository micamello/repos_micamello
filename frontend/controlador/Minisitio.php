...
//print_r($facetas[$value['id_faceta']]);
...
//echo $cantd_op.' == '.$cont_opciones;
                if($cantd_op === $cont_opciones){
                  ...
                  foreach ($facetas as $key => $literales) {
                      $promedios[$facetas[$value['id_faceta']]] = round(array_sum($porc_por_preguntas[$literales])/$preg_x_faceta,2);
                      $td .= '<td align="center" style="vertical-align:middle;">'.$promedios[$facetas[$value['id_faceta']]].'</td>';
                  }
    ...
    public function generaInforme($datos){
      ...
      $cantd_preg = 0;
      $parrafo = $faceta = $porcentaje_faceta = $etiquetas_faceta = $colors = $descrip_facetas = '';
      ...
      $informe .= '<p align="center"><img align="center" src="https://chart.googleapis.com/chart?chs=500x300&chd=t:'.$porcentajes_faceta.'&cht=p&chl='.$etiquetas_faceta.'&chco='.$colors.'&chtt=CANEA&chdl='.$descrip_facetas.'" class="img-responsive"></p>';
