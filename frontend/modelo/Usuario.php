...
WHERE
  ...
  public static function crearUsuario($dato_registro){   
    ...
    if ($dato_registro['tipo_usuario'] == 1) {
      ...
      $arreglo_datos = array('telefono'=>$dato_registro['telefono'], 'nombres'=>$dato_registro['nombres'], 'fecha_creacion'=>$dato_registro['fecha_creacion'], 'term_cond'=>$dato_registro['term_cond'], 'id_ciudad'=>$dato_registro['id_ciudad'], 'id_nacionalidad'=>$dato_registro['id_nacionalidad'], 'id_usuario_login'=>$dato_registro['id_usuario_login'],'estado'=>$dato_registro['estado'], 'id_sectorindustrial'=>$dato_registro['id_sectorindustrial']);
