		...
		$('#password_1').on('blur', function(){
			if($(this).val() != ""){
				if(validarPassword($(this).val())){
					...
					crearMensajeError($(this), "Mín. 8, Máx. 50 caracteres, 1 letra, 1 número");
				}
			}
			else{
				crearMensajeError($(this), "Rellene este campo");
	...
	if($('#password_1').length){
		if($('#password_1').val() != ""){
			if(validarPassword($('#password_1').val())){
				...
				crearMensajeError($('#password_1'), "Mín. 8, Máx. 50 caracteres, 1 letra, 1 número");
			}
		}
		else{
	...
	if($('#password_2').length){
		if($('#password_2').val() != ""){
			if(validarPassword($('#password_2').val())){
				...
				crearMensajeError($('#password_2'), "Mín. 8, Máx. 50 caracteres, 1 letra, 1 número");
			}
		}
		else{
