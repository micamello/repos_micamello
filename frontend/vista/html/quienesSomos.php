    ...
    <div class="container">
      <div class="row">
        <div  style="margin-top: 20px; text-align:center" class="col-md-12">
          <div class="col-md-6">
            <p class="qs-text qs-mv">Mi Camello, es un moderno y novedoso portal web de empleo que apunta al reclutamiento 3.0 enfocada a facilitar el desarrollo profesional, ofreciendo a las empresas herramientas innovadoras para la gesti&oacute;n de los procesos de selecci&oacute;n y facilita a los profesionales el acceso a nuevas oportunidades de trabajo, de manera que sea una experiencia &uacute;nica para empresas y candidatos.</p>
          </div>

          <div class="col-md-6">
            <img width="100%" src="<?php echo PUERTO.'://'.HOST.'/imagenes/qs2.jpg'; ?>" alt="quienesSomos">
          </div>
        </div>
        ...
        <div style="margin-top: 20px;" align="center" class="col-md-12  col-sm-12 col-xs-12">
          ...
          <ul class="col-md-8 col-md-offset-2 qs-text">
            ...
            <li class="qs-text-lista"><p id="margin-b-15" class="lista-valores">Innovación: Contamos con herramientas tecnológicas de última generación que facilitarán nuestro desempeño en el mundo digital.</p></li>
            <li class="qs-text-lista"><p id="margin-b-15" class="lista-valores">Transparencia: Realizamos nuestra gestión de forma objetiva, clara y verificable</li>
            <li class="qs-text-lista"><p id="margin-b-15" class="lista-valores">Eficiencia: Tenemos el claro objetivo de fortalecer la confianza en todos los candidatos, el 
            empresariado y servir de enlace entre ellos.</p></li>
          </ul>
        </div>
      </div>
    </div>
