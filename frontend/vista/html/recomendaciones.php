            ...
            <form role="form" id="form_recomendaciones" method="post" action="<?php echo PUERTO."://".HOST;?>/recomendacion/">
                ...
                <div class="col-md-12">
                    <div class="form-group" id="seccion_correo">
                        <label for="correo">Correo</label><div id="err_correo" class="help-block with-errors"></div>
                ...
                <div class="col-md-12">
                    <div class="form-group" id="seccion_telefono">
                        <label for="telefono">Tel&eacute;fono</label><div id="err_telefono" class="help-block with-errors"></div>
                ...
                <div class="col-md-12">
                    <div class="form-group" id="seccion_descripcion">
                        <label for="descripcion">Descripci&oacute;n</label><div id="err_descripcion" class="help-block with-errors"></div>
