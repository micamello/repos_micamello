			           	...
			           	<div class="col-md-12">
				            <div id="seccion_clave_ant" class="form-group">
			                  ...
			                  <div class="input-group">
			                    ...
			                    <input id="password_ant" name="password_ant" type="password" pattern="^(?=(?:.*\d))(?=(?:.*[a-zA-Z]))\S{8,}$" class="form-control <?php echo $noautofill; ?>" value="<?php if(isset($data['password_ant'])){ echo $data['password_ant']; } ?>" onkeyup="validarClave()" <?php echo $readonly; ?>>
			                  </div>
			                </div>
			          	</div>
