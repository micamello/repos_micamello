                      ...
                      <div class="row">  
                        ...
                        <div class="col-md-offset-3 col-md-6">
                          <div class="form-group" style="text-align: center" id="seccion_plan">
                            <label for="plan" style="font-size:18px" class="campo">Seleccione un Plan <span class="requerido" title="Este campo es obligatorio">*</span></label><div id="err_plan" class="help-block with-errors"></div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="sector">
                              <p class="campo">Sector Industrial&nbsp;<span class="requerido" title="Este campo es obligatorio">*</span></p><div id="err_sector" class="help-block with-errors"></div>
                        ...
                        <div class="col-md-12 form-group" id="correo_group">
                            ...
                            <p class="campo">Correo&nbsp;<span class="requerido" title="Este campo es obligatorio">*</span></p><div id="correo_div_error" class="help-block with-errors"></div>
                        ...
                        <div class="col-md-6">
                           <div class="form-group" id="seccion_num">
                             <p for="numero_cand" class="campo">Tel&eacute;fono&nbsp;<span class="requerido" title="Este campo es obligatorio">*</span></p><div id="err_num" class="help-block with-errors"></div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="dni_group">
                              <p class="campo">RUC&nbsp;<span class="requerido" title="Este campo es obligatorio">*</span></p><div id="dni_error" class="help-block with-errors"></div>
                        ...
                        <div class="col-md-12" id="contact_company_section">
                          ...
                          <div class="col-md-6 form-group" id="group_nombre_contact">
                              <p class="campo">Nombres&nbsp;<span class="requerido" title="Este campo es obligatorio">*</span></p><div id="nom_cont" class="help-block with-errors"></div>
                          ...
                          <div class="col-md-6 form-group" id="group_apell_contact">
                            <p class="campo">Apellidos&nbsp;<span class="requerido" title="Este campo es obligatorio">*</span></p><div id="err_apell" class="help-block with-errors"></div>
                          ...
                          <div class="col-md-6 form-group" id="group_num1_contact">
                            <p class="campo">Celular&nbsp;<span class="requerido" title="Este campo es obligatorio">*</span></p><div id="tel_err" class="help-block with-errors"></div>
                          ...
                          <div id="seccion_postulacion" style="display: none;" >
                            <div class="col-md-6">
                              <div class="caja-cuenta-2" id="recursos1">
                                ...
                                <input type="number" min="0" pattern="^[0-9]+" name="num_post" id="num_post" onkeyup="calRec()" onclick="calRec()" onchange="calRec()" onkeydown="return validaNumeros(event);" class="form-control" value="<?php if(isset($data['num_post']) && !empty($data['num_post'])){ echo $data['num_post']; }else{ echo '0'; } ?>" placeholder="0">
                            ...
                            <div class="col-md-6">
                              <div class="caja-cuenta-2" id="recursos3">
                                ...
                                <label style="margin-bottom: 0px;" for="numAcces">N&uacute;mero de Accesos&nbsp;</label><span class="requerido" title="Este campo es obligatorio">*</span><div id="rec3" class="help-block with-errors" style="margin: 0px; height: 15px;"></div>
                                    <input type="number" min="0" pattern="^[0-9]+" name="num_accesos" id="num_accesos" onkeyup="calRec()" onclick="calRec()" onchange="calRec()" onkeydown="return validaNumeros(event);" class="form-control" value="<?php if(isset($data['num_accesos']) && !empty($data['num_accesos'])){ echo $data['num_accesos']; }else{ echo '0'; } ?>" placeholder="0">
