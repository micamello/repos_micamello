	                                ...
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="col-md-6">
	                                        <div class="form-group">
	                                			...
	                                			<input class="form-control" type="text" id="apellidos" name="apellidos" value="<?php if(isset($_SESSION['mfo_datos']['usuario']['apellidos'])){ echo $_SESSION['mfo_datos']['usuario']['apellidos']; } ?>" pattern='[a-z A-ZñÑáéíóúÁÉÍÓÚ]+' <?php if($btnSig == 1){ echo 'readonly'; } ?> required/>
	                                        </div>
	                                    </div>
	                                    <?php } ?>
	                                    ...
	                                    <div class="col-md-<?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { echo '6'; }else{ echo '12';} ?>">
		                                    <div class="form-group">
	                                            <label for="nacionalidad">Nacionalidad</label><div class="help-block with-errors"></div>
	                                            <select class="form-control" name="id_pais" id="id_pais" <?php if($btnSig == 1){ echo 'readonly'; } ?> required>
	                                    ...
	                                    <fieldset  style="padding: 15px 0px 0px 0px;" class="form-group col-md-12">
    										<legend style="font-size: 12px; color: #8c8b8b; margin-bottom: 5px;">Direcci&oacute;n domiciliaria</legend>
		                                    <div class="col-md-6">
		                                        <div class="form-group">
	                                    ...
	                                    <div class="col-md-6">
	                                    	<div class="form-group">
		                                    	<label for="estado_civil">Estado civil</label><div class="help-block with-errors"></div>
			                                    <select id="estado_civil" name="estado_civil" class="form-control" <?php if($btnSig == 1){ echo 'readonly'; } ?> required>
			                                    	<option value="">Seleccione una opci&oacute;n</option>
			                                    	<?php 
										...
										<div class="col-md-6">
	                                    	<div class="form-group">
		                                    	<label for="tiene_trabajo">&#191;Tiene trabajo&#63;</label><div class="help-block with-errors"></div>
			                                    <select id="tiene_trabajo" name="tiene_trabajo" class="form-control" <?php if($btnSig == 1){ echo 'readonly'; } ?> required>
			                                    	<option value="">Seleccione una opci&oacute;n</option>
			                                    	<?php 
										...
										<div class="col-md-6">
	                                    	<div class="form-group">
		                                    	<label for="viajar">&#191;Puede viajar&#63;</label><div class="help-block with-errors"></div>
			                                    <select id="viajar" name="viajar" class="form-control" <?php if($btnSig == 1){ echo 'readonly'; } ?> required>
			                                    	<option value="">Seleccione una opci&oacute;n</option>
			                                    	<?php 
			                                    	foreach(REQUISITO as $key => $r){ 
														echo "<option value='$key'";
										...
										<div class="col-md-6">
	                                    	<div class="form-group">
		                                    	<label for="licencia">&#191;Tiene licencia para conducir&#63;</label><div class="help-block with-errors"></div>
			                                    <select id="licencia" name="licencia" class="form-control" <?php if($btnSig == 1){ echo 'readonly'; } ?> required>
			                                    	<option value="">Seleccione una opci&oacute;n</option>
			                                    	<?php 
			                                    	 //echo $_SESSION['mfo_datos']['usuario']['licencia']; exit;
			                                    	foreach(REQUISITO as $key => $r){ 
														echo "<option value='$key'";
	                                    ...
	                                    <div class="col-md-3" style="padding-right: 0px;">
	                                        <div class="form-group">
	                                            <label for="escolaridad">Estudios</label><div class="help-block with-errors"></div>
	                                    ...
	                                    <div class="col-md-3">
	                                    	<div class="form-group">
	                                    		<label for="estatus">Nivel</label><div class="help-block with-errors"></div>
												 <select id="estatus" name="estatus" class="form-control" style="padding-left: 0px;" <?php if($btnSig == 1){ echo 'readonly'; } ?> required>
												 	<option value="">Seleccione su opci&oacute;n</option>
													<?php 
	                                    ...
	                                    <div class="col-md-6">
	                                        <div class="form-group">
	                                            <label for="universidad">Universidad</label><div class="help-block with-errors"></div>
	                                            <select class="form-control" id="universidad" name="universidad" <?php if($btnSig == 1){ echo 'disabled'; } ?> required>
	                                            	<option value="">Seleccione su opci&oacute;n</option>
													<?php 
													if (!empty($universidades)){
				                                    	foreach($universidades as $key => $u){ 
															echo "<option value='".$u['id_univ']."'";
															if ($_SESSION['mfo_datos']['usuario']['id_univ'] == $key)
															{ 
																echo " selected='selected'";
															}
