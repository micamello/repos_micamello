						...
						<div class="panel panel-default">
							<div class="">
								<div class="">
									...
									<!--eliminar este boton e insertar su funcionalidad en siguiente
										pasar un parametro al hacer click en sig donde se identifique que esta editando
										y recargar esta pag y luego redireccionar!-->
										<div align="center">
											
											<input type="button" id="boton" name="" class="btn-blue" value="CONTINUAR">

											<?php 
											if($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO)
											{ 
												$defaultnext = "cuestionario";		/*Que contiene la var $ca??*/
												if(!isset($_SESSION['mfo_datos']['usuario']['infohv']) && $ca > 2){
													$defaultnext = "cargarhojavida";
												}?>
												<input type="hidden" name="redirect" id="redirect" value="<?php echo $defaultnext;?>">
												<!-- <a href="<?php /*echo PUERTO."://".HOST."/".$defaultnext."/";?>" class="btn-light-blue btnPerfil <?php if($btnSig == 0){ echo ''; } ?>" 

													<?php 
													if($btnSig == 0){ echo ''; }*/ ?>>SIGUIENTE
												</a> -->

											<?php } /*cierre del if ($_SESSION::CANDIDATO)*/

											else{?>
												<input type="hidden" name="redirect" id="redirect" value="publicar">
