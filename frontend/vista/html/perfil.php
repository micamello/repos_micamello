...
<div class="container">
	<div class="checkout-wrap">
	  <ul class="checkout-bar">
        ...
        for($i=1;$i<=3;$i++){ ?>
          <?php
          	if (count($porcentaje_por_usuario) == count($nrototalfacetas)){ 
          		$clase = "visited";
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div id="seccion_nombre" class="form-group">
                                            <label for="nombres"><?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?> Nombres <?php }else{ ?> Nombre de la empresa<?php } ?><span title="Este campo es obligatorio">*</span></label><div id="err_nom" class="help-block with-errors"></div>
                                    ...
                                    <?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?>
	                                    <div class="col-md-6">
	                                        <div id="seccion_apellido" class="form-group">
	                                            <label for="apellidos">Apellidos<span title="Este campo es obligatorio">*</span></label><div id="err_ape" class="help-block with-errors"></div>

	                                			<input class="form-control" type="text" id="apellidos" name="apellidos" maxlength="100" value="<?php if(isset($data['apellidos'])){ echo utf8_encode($data['apellidos']); } else{ echo utf8_encode($_SESSION['mfo_datos']['usuario']['apellidos']); } ?>" pattern='[a-z A-ZñÑáéíóúÁÉÍÓÚ]+'  onkeyup="validarFormulario(false)" />
	                                        </div>
	                                    </div>
                                	...
                                	<?php }else{  ?>
                                		...
                                		<div class="col-md-6">
							                <div class="form-group" id="seccion_sector">
							                  <label>Sector industrial <i>*</i></label>
                                    ...
                                    <?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?>
                                    	...
                                    	<div class="col-md-6">
										    <div id="seccion_tlf" class="form-group">
										        <label for="telefono">Celular <span title="Este campo es obligatorio">*</span></label><div id="err_tlf" class="help-block with-errors"></div>
                                    ...
                                    <div class="col-md-6">
	                                    <div id="seccion_nac" class="form-group">
                                            <label for="nacionalidad"><?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?> Nacionalidad <?php }else{ ?> Pais <?php } ?> <span title="Este campo es obligatorio">*</span></label><div id="err_nac" class="help-block with-errors"></div>
									...
									<?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::EMPRESA) { ?>
										...
										<div class="col-md-6">
										    <div id="seccion_nro" class="form-group">
										        <label for="nro_trabajadores">N&uacute;mero de Trabajadores <span title="Este campo es obligatorio">*</span></label><div id="err_nro" class="help-block with-errors"></div>
										...
										<div class="col-md-4">
										    <div id="seccion_tlf" class="form-group">
										        <label for="telefono">Tel&eacute;fono <span title="Este campo es obligatorio">*</span></label><div id="err_tlf" class="help-block with-errors"></div>
                                    ...
                                    <div class="col-md-<?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { echo '6'; }else{ echo '4'; } ?>">
                                        <div id="seccion_provincia" class="form-group">
                                            <label for="provincia">Provincia<?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?> de Residencia <?php } ?><span title="Este campo es obligatorio">*</span></label><div id="err_prov" class="help-block with-errors"></div>
                                    ...
                                    <div class="col-md-<?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { echo '6'; }else{ echo '4'; } ?>">
                                        <div id="seccion_ciudad" class="form-group">
                                            <label for="ciudad">Ciudad<?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?> de Residencia <?php } ?><span title="Este campo es obligatorio">*</span></label><div id="err_ciu" class="help-block with-errors"></div>
                                    ...
                                    <?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?>
										...
										<div class="col-md-6">
	                                    	<div id="seccion_civil" class="form-group">
		                                    	<label for="estado_civil">Estado civil <span title="Este campo es obligatorio">*</span></label><div id="err_civil" class="help-block with-errors"></div>
	                                    ...
	                                    <div class="col-md-6">
	                                    	<div id="seccion_res" class="form-group">
		                                    	<label for="residencia">&#191;Puede cambiar de residencia&#63; <span title="Este campo es obligatorio">*</span></label><div id="err_res" class="help-block with-errors"></div>
										...
										<div class="col-md-6">
	                                    	<div id="seccion_trab" class="form-group">
		                                    	<label for="tiene_trabajo">Situaci&oacute;n Laboral <span title="Este campo es obligatorio">*</span></label><div id="err_trab" class="help-block with-errors"></div>
										...
										<div class="col-md-6">
	                                    	<div id="seccion_via" class="form-group">
		                                    	<label for="viajar">&#191;Puede viajar&#63; <span title="Este campo es obligatorio">*</span></label><div id="err_via" class="help-block with-errors"></div>
										...
										<div class="col-md-6">
	                                    	<div id="seccion_lic" class="form-group">
		                                    	<label for="licencia">Tipo de Licencia <span title="Este campo es obligatorio">*</span></label><div id="err_lic" class="help-block with-errors"></div>
 										...
 										<div class="col-md-6">
	                                    	<div id="seccion_dis" class="form-group">
		                                    	<label for="discapacidad">Discapacidad <span title="Este campo es obligatorio">*</span></label><div id="err_dis" class="help-block with-errors"></div>
	                                    ...
	                                    <div class="col-md-12" >
	                                        <div id="seccion_esc" class="form-group">
	                                            <label for="escolaridad">&Uacute;ltimo estudio realizado <span title="Este campo es obligatorio">*</span></label><div id="err_esc" class="help-block with-errors"></div>
										...
										<div class="col-md-6 depende" hidden>
	                                        <div id="seccion_estudio" class="form-group">
	                                            <label for="lugar_estudio">&#191;Estudi&oacute; en el extranjero&#63; <span title="Este campo es obligatorio">*</span></label><div id="err_estudio" class="help-block with-errors"></div>
	                                    ...
	                                    <div hidden class="col-md-6 depende">
	                                        <div id="seccion_univ" class="form-group">
	                                            <label for="universidad">Universidad <span title="Este campo es obligatorio">*</span></label><div id="err_univ" class="help-block with-errors"></div>
                                    	...
                                    	<div class="form-group col-md-12">
								            ...
								            <div class="col-md-4" id="group_num1_contact">
								              <div id="seccion_tlfCel" class="form-group">
								                <label class="text-center">Celular</label>&nbsp;<i>*</i><div id="err_tlfCel" class="help-block with-errors"></div>
      ...
      <div class="modal-header">
        <h5 class="titulo-modal-hoja modal-title">Cambio de Contrase&ntilde;a</h5>                  
	      ...
	      <div class="modal-footer" style="text-align: center !important;">
			...
			<input type="button" id="button_cambiar" name="button_cambiar" class="btn-light-blue" value="Cambiar">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="col-md-12">
                ...
                <p class="text-center" id="texto_status"></p>
              </div>
            </div>
          </div>
        </div>
