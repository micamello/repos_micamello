	                                    ...
	                                    <?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?>
		                                    ...
		                                    <div class="col-md-6">
			                                    <div class="form-group" id="seccion_dni">
			                                        ...
			                                        <input class="form-control" type="text" id="dni" name="dni" <?php if($_SESSION['mfo_datos']['usuario']['dni'] == 0){ echo ''; }else{ echo 'disabled';} ?> value="<?php if(isset($data['dni'])){ echo $data['dni']; } else{ if($_SESSION['mfo_datos']['usuario']['dni'] == 0){ echo ''; }else{ echo $_SESSION['mfo_datos']['usuario']['dni']; } } ?>" onkeyup="validarFormulario()" />
			                                    </div>
		                                    </div>
	                                	<?php } ?>
