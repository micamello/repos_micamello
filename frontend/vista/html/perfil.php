	                       ...
	                       <?php if($btnDescarga == 1){ ?>
							...
							if($btnSubir == 1 || isset($data)){ ?>
								<div <?php if($btnDescarga == 1){ echo 'class="pull-right" style="position: relative; margin-right: 15px;"'; } ?>>
			                        ...
			                        <?php if($btnDescarga != 1){ echo '<p id="mensaje_error_hv" class="parpadea" style="font-size:11px;color:red">Cargar la hoja de vida es obligatorio *</p>'; } ?>
				            	...
				            	<div class="main_business">
	                                <div class="col-md-12">
	                                    ...
	                                    <div class="col-md-6">
	                                        <div id="seccion_nombre" class="form-group">
	                                			...
	                                			<input class="form-control" type="text" id="nombres" name="nombres" value="<?php if(isset($data)){ echo $data['nombres']; } else{ echo $_SESSION['mfo_datos']['usuario']['nombres']; } ?>" pattern="[a-z A-ZñÑáéíóúÁÉÍÓÚ]+" <?php if($btnSig == 1){ echo 'disabled'; } ?> onkeyup="validarFormulario()" required/>
	                                        </div>
	                                    </div>
	                                    ...
	                                    <?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?>
		                                    <div class="col-md-6">
		                                        <div id="seccion_apellido" class="form-group">
		                                			...
		                                			<input class="form-control" type="text" id="apellidos" name="apellidos" value="<?php if(isset($data)){ echo $data['apellidos']; } else{ echo $_SESSION['mfo_datos']['usuario']['apellidos']; } ?>" pattern='[a-z A-ZñÑáéíóúÁÉÍÓÚ]+' <?php if($btnSig == 1){ echo 'disabled'; } ?> onkeyup="validarFormulario()" required/>
		                                        </div>
		                                    </div>
	                                    <?php } ?>
	                                    ...
	                                    <div class="col-md-<?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { echo '6'; }else{ echo '12';} ?>">
		                                    <div id="seccion_nac" class="form-group">
	                                            ...
	                                            <select class="form-control" name="id_nacionalidad" id="id_nacionalidad" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
													...
													if (!empty($nacionalidades)){
				                                    	foreach($nacionalidades as $key => $n){ 
															...
															if ($_SESSION['mfo_datos']['usuario']['id_nacionalidad'] == $n['id_pais'] || (isset($data) && $data['id_nacionalidad'] == $n['id_pais']))
															{ 
	                                    ...
	                                    <div class="col-md-6">
		                                    <div id="mayoria"  class="form-group">
		                                        ...
		                                        <input class="form-control" type="date" name="fecha_nacimiento" id="fecha_nacimiento" value="<?php if(isset($data)){ echo $data['fecha_nacimiento']; } else{ echo date('Y-m-d',strtotime($_SESSION['mfo_datos']['usuario']['fecha_nacimiento'])); } ?>" <?php if($btnSig == 1){ echo 'disabled'; } ?> <?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?> onchange="calcularEdad()" <?php } ?> placeholder="dd/mm/aaaa" onkeyup="validarFormulario()" required/>
		                                    </div>
	                                    </div>
										...
										<?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::EMPRESA) { ?>
											...
											<div class="col-md-6">
											    <div id="seccion_tlf" class="form-group">
											        ...
											        <input class="form-control" type="text" id="telefono" name="telefono" minlength="10" maxlength="15" pattern='[0-9]+' onkeydown="return validaNumeros(event)" value="<?php if(isset($data)){ echo $data['telefono']; } else{ echo $_SESSION['mfo_datos']['usuario']['telefono']; } ?>" <?php if($btnSig == 1){ echo 'disabled'; } ?> onkeyup="validarFormulario()" required/>
											    </div>
											</div>
	                                    ...
	                                    <div class="form-group col-md-12">
		                                    ...
		                                    <div class="col-md-6">
		                                        <div id="seccion_provincia" class="form-group">
		                                            ...
		                                            <select class="form-control" name="provincia" id="provincia" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
														...
														if (!empty($arrprovincia)){
					                                    	...
					                                    	foreach($arrprovincia as $key => $pr){ 
																...
																if ($provincia == $pr['id_provincia'] || (isset($data) && $data['provincia'] == $pr['id_provincia']))
																{ 
																	echo " selected='selected'";
																}
		                                    ...
		                                    <div class="col-md-6">
		                                        <div id="seccion_ciudad" class="form-group">
		                                            ...
		                                            <select id="ciudad" name="ciudad" class="form-control" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
		                                            <?php 
		                                            if(!empty($arrciudad)){
				                                    	foreach($arrciudad as $key => $ciudad){ 
															echo "<option value='".$ciudad['id_ciudad']."'";
															if ($_SESSION['mfo_datos']['usuario']['id_ciudad'] == $ciudad['id_ciudad'] || (isset($data) && $data['ciudad'] == $ciudad['id_ciudad']))
															{  
																echo " selected='selected'";
															}
	                                    ...
	                                    <?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::CANDIDATO) { ?>
		                                    <div class="col-md-6">
		                                    	<div id="seccion_dis" class="form-group">
				                                    ...
				                                    <select id="discapacidad" name="discapacidad" class="form-control" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
				                                    	<option value="-1">Tiene alguna discapacidad&#63;</option>
				                                    	<?php 
				                                    	foreach(REQUISITO as $key => $dis){ 
															echo "<option value='$key'";
															if ($_SESSION['mfo_datos']['usuario']['discapacidad'] == $key || (isset($data) && $data['discapacidad'] == $key))
															{ 
																echo " selected='selected'";
															}
															echo ">$dis</option>";
											...
											<div class="col-md-6">
		                                        <div id="seccion_exp" class="form-group">
		                                            ...
		                                            <select id="experiencia" name="experiencia" class="form-control" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
		                                            	<option value="0">Seleccione una opci&oacute;n</option>
		                                            <?php 
				                                    	foreach(ANOSEXP as $key => $exp){ 
															echo "<option value='$key'";
															if ($_SESSION['mfo_datos']['usuario']['anosexp'] == $key || (isset($data) && $data['experiencia'] == $key))
															{ 
																echo " selected='selected'";
															}
															echo ">$exp</option>";
		                                    ...
		                                    <div class="col-md-6">
		                                    	<div id="seccion_civil" class="form-group">
				                                    ...
				                                    <select id="estado_civil" name="estado_civil" class="form-control" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
				                                    	<option value="0">Seleccione una opci&oacute;n</option>
				                                    	<?php 
				                                    	foreach(ESTADO_CIVIL as $key => $e){ 
															echo "<option value='$key'";
															if ($_SESSION['mfo_datos']['usuario']['estado_civil'] == $key || (isset($data) && $data['estado_civil'] == $key))
															{ 
																echo " selected='selected'";
															}
															echo ">$e</option>";
		                                    ...
		                                    <div class="col-md-6">
		                                        <div id="seccion_gen" class="form-group">
		                                            ...
		                                            <select id="genero" name="genero" class="form-control" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
														<option value="0">Seleccione un genero</option>
				                                    	<?php 
				                                    	foreach(GENERO as $key => $ge){ 
															echo "<option value='$key'";
															if ($_SESSION['mfo_datos']['usuario']['genero'] == $key || (isset($data) && $data['genero'] == $key))
															{ 
																echo " selected='selected'";
															}
															echo ">$ge</option>";
											...
											<div class="col-md-6">
		                                    	<div id="seccion_trab" class="form-group">
				                                    ...
				                                    <select id="tiene_trabajo" name="tiene_trabajo" class="form-control" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
				                                    	<option value="0">Seleccione una opci&oacute;n</option>
				                                    	<?php 
				                                    	foreach(REQUISITO as $key => $r){ 
															echo "<option value='$key'";
															if ($_SESSION['mfo_datos']['usuario']['tiene_trabajo'] == $key || (isset($data) && $data['tiene_trabajo'] == $key))
															{ 
																echo " selected='selected'";
															}
															echo ">$r</option>";
											...
											<div class="col-md-6">
		                                    	<div id="seccion_via" class="form-group">
				                                    ...
				                                    <select id="viajar" name="viajar" class="form-control" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
				                                    	<option value="0">Seleccione una opci&oacute;n</option>
				                                    	<?php 
				                                    	foreach(REQUISITO as $key => $r){ 
															echo "<option value='$key'";
															if ($_SESSION['mfo_datos']['usuario']['viajar'] == $key || (isset($data) && $data['viajar'] == $key))
															{ 
																echo " selected='selected'";
															}
															echo ">$r</option>";
											...
											<div class="col-md-6">
		                                    	<div id="seccion_lic" class="form-group">
				                                    ...
				                                    <select id="licencia" name="licencia" class="form-control" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
				                                    	<option value="0">Seleccione una opci&oacute;n</option>
				                                    	<?php 
				                                    	
				                                    	foreach(REQUISITO as $key => $r){ 
															echo "<option value='$key'";
															if ($_SESSION['mfo_datos']['usuario']['licencia'] == $key || (isset($data) && $data['licencia'] == $key))
															{ 
																echo " selected='selected'";
															}
															echo ">$r</option>";
		                                            ...
		                                            <select id="escolaridad" name="escolaridad" class="form-control" onchange="ocultarCampos()"style="padding-left: 0px;" <?php if($btnSig == 1){ echo 'disabled'; } ?> required>
														...
														if (!empty($escolaridad)){
					                                    	foreach($escolaridad as $key => $es){ 
																...
																if ($_SESSION['mfo_datos']['usuario']['id_escolaridad'] == $es['id_escolaridad'] || (isset($data) && $data['escolaridad'] == $es['id_escolaridad']))
																{ 
																	echo " selected='selected'";
																}
		                                    ...
		                                    <div class="col-md-6">
		                                    	<div id="seccion_est" class="form-group">
		                                    		<label for="estatus">Nivel <span class="requerido" title="Este campo es obligatorio">*</span></label><div id="err_est" class="help-block with-errors"></div>
													 <select id="estatus" name="estatus" class="form-control" style="padding-left: 0px;" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
													 	<option value="0">Seleccione su opci&oacute;n</option>
														<?php 
				                                    	foreach(STATUS_CARRERA as $key => $status){ 
															echo "<option value='".$key."'";
															if ($_SESSION['mfo_datos']['usuario']['status_carrera'] == $key || (isset($data) && $data['estatus'] == $key))
															{ 
																echo " selected='selected'";
															}
											...
											<div class="col-md-6 depende">
		                                        <div id="seccion_estudio" class="form-group">
		                                            ...
		                                            <select class="form-control" id="lugar_estudio" name="lugar_estudio" onchange='mostrarUni(); validarFormulario();' <?php if($btnSig == 1){ echo 'disabled'; } ?> >
		                                    ...
		                                    <div class="col-md-6 depende">
		                                        <div id="seccion_univ" class="form-group">
		                                            ...
		                                            <select class="form-control" id="universidad" name="universidad" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" >
		                                            	<option value="0">Seleccione su opci&oacute;n</option>
														<?php 
														if (!empty($universidades)){
					                                    	foreach($universidades as $key => $u){ 
																echo "<option value='".$u['id_univ']."'";
																if ($_SESSION['mfo_datos']['usuario']['id_univ'] == $u['id_univ'] || (isset($data) && $data['universidad'] == $u['id_univ']))
																{ 
																	echo " selected='selected'";
																}
													...
													<input type="text" name="universidad2" id="universidad2" class="form-control" <?php if($btnSig == 1){ echo 'disabled'; } ?>  pattern="[a-z A-ZñÑáéíóúÁÉÍÓÚ.]+" style="display:none" onkeyup="validarFormulario()" value="<?php if(isset($data)){ echo $data['universidad2']; } else{ if($_SESSION['mfo_datos']['usuario']['nombre_univ'] != ' '){ echo $_SESSION['mfo_datos']['usuario']['nombre_univ']; } } ?>">
		                                        </div>
		                                    </div>

		                                    <div class="col-md-6">
		                                        <div id="seccion_area" class="form-group">
		                                            <label for="area_select">&Aacute;reas de inter&eacute;s <span class="requerido" title="Este campo es obligatorio">*</span></label><span class="help-text"> (m&aacute;x 3)</span><div id="err_area" class="help-block with-errors"></div>
		                                            <?php if (!empty($arrarea)){
					                                    	...
					                                    	foreach($arrarea as $key => $ae){ 
																...
																{ 
																	$optiones .= '<p class="col-md-12 badge_item3" id="area'.$ae['id_area'].'">'.utf8_encode($ae['nombre']).'<i class="fa fa-window-close fa-2x icon" style="cursor:pointer;" ';
																	if($btnSig != 1){
																		$optiones .= 'onclick="eliminar_item_selected(\'area'.$ae['id_area'].'\',\'area_select\',\''.$ae['id_area'].'\'); validarFormulario();"';
																	}
																	$optiones .= '></i></p>';
																}
																//$b++;
													...
													<div class="opcionesSeleccionados">
														...
														<div class="row">
				                                            <select class="form-control" multiple id="area_select" data-selectr-opts='{"maxSelection": 3 }' name="area_select[]" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
																<?php 
																if (!empty($arrarea)){
							                                    	foreach($arrarea as $key => $ae){ 
		                                    ...
		                                    <div class="col-md-6">
		                                        <div id="seccion_int" class="form-group">
		                                            <label for="nivel_interes">Niveles de inter&eacute;s  </label><span class="help-text"> (m&aacute;x 2)</span><div id="err_int" class="help-block with-errors"></div>
		                                            <?php if (!empty($arrinteres)){
		                                            	   ...
		                                            	   // $a = 1;
					                                    	foreach($arrinteres as $key => $ae){ 
																...
																{ 
																	$optiones .= '<p class="col-md-12 badge_item3" id="nivel'.utf8_encode($ae['id_nivelInteres']).'">'.utf8_encode($ae['descripcion']).'<i class="fa fa-window-close fa-2x icon" style="cursor:pointer;" ';
																	if($btnSig != 1){
																		$optiones .= 'onclick="eliminar_item_selected(\'nivel'.$ae['id_nivelInteres'].'\',\'nivel_interes\',\''.$ae['id_nivelInteres'].'\'); validarFormulario();"';
																	}
																	$optiones .= '></i></p>';
																}
																//$a++;
													...
													<div class="opcionesSeleccionados">
														...
														<div class="row">
				                                            <select class="form-control" multiple id="nivel_interes" data-selectr-opts='{"maxSelection": 2 }' name="nivel_interes[]" <?php if($btnSig == 1){ echo 'disabled'; } ?> onchange="validarFormulario()" required>
																<?php 
																if (!empty($arrinteres)){
							                                    	foreach($arrinteres as $key => $ae){ 
	                                    	...
	                                    	<div class="form-group col-md-12">
									            ...
									            <div class="col-md-6" id="group_num1_contact">
									              <div id="seccion_tlfCon" class="form-group">
									                ...
									                <input type="text" name="tel_one_contact" id="tel_one_contact" value="<?php echo $_SESSION['mfo_datos']['usuario']['telefono1']; ?>" class="form-control" pattern='[0-9]+' onkeyup="validarFormulario()" onkeydown="return validaNumeros(event)" <?php if($btnSig == 1){ echo 'disabled'; } ?> <?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::EMPRESA) { echo 'required'; } ?>>
									              </div>
									            </div> 
									            ...
									            <div class="col-md-6" id="group_num2_contact">
									              <div class="form-group">
									                ...
									                <input type="text" name="tel_two_contact" id="tel_two_contact" value="<?php echo $_SESSION['mfo_datos']['usuario']['telefono2']; ?>" class="form-control" pattern='[0-9]+' onkeydown="return validaNumeros(event)" <?php if($btnSig == 1){ echo 'disabled'; } ?>>
									              </div>
									            </div> 
									        </div>
								        <?php } ?>
					                ...
					                <div class="row">
										...
										<?php }else{ ?>
											...
											<?php }else{ 	?>
												<a href="<?php echo PUERTO."://".HOST;?>/publicar/" class="btn btn-success">SIGUIENTE</a>
										    <?php }
										}?>
									</div>
				            	</div>  
			        ...
			        <div class="col-md-6">
		                <div id="seccion_clave" class="form-group">
		                  ...
		                  <div class="input-group">
		                    ...
		                    <input title="Letras y números, mínimo 8 caracteres" id="password" name="password" type="password" pattern="^(?=(?:.*\d))(?=(?:.*[a-zA-Z]))\S{8,}$" onchange="this.setCustomValidity(this.validity.patternMismatch ? this.title : ''); if(this.checkValidity()) form.password_two.pattern = this.value;" class="form-control" onkeyup="validarClave()" required>
		                  </div>
		                </div>
		            </div>
		            <div class="col-md-6">
		              <div id="seccion_clave1" class="form-group">
		                  ...
		                  <div class="input-group">
		                    <span class="input-group-addon show_hidden" onclick="pass_reveal(this);"><i class="fa fa-eye"></i></span>
		                    <input id="password_two" name="password_two" type="password" pattern="^(?=(?:.*\d))(?=(?:.*[a-zA-Z]))\S{8,}$" onchange="this.setCustomValidity(this.validity.patternMismatch ? 'Ingrese la misma contraseña' : '');" placeholder="Verificar contraseña" class="form-control" onkeyup="validarClave()" required>
		                </div>
		              </div>
		            </div> 
				</div>
