          ...
          <form action = "<?php echo PUERTO."://".HOST;?>/contrasena/<?php echo $token;?>/" method = "post" id="form_contrasena" name="form_contrasena">
            <div class="col-md-12">
              <div class="form-group" id="seccion_clave">
                <label>Nueva Contrase&ntilde;a <span title="Este campo es obligatorio">*</span></label><div id="err_password" class="help-block with-errors"></div>
            ...
            <div class="col-md-12">
              <div class="form-group" id="seccion_clave1">
                <label>Confirme Contrase&ntilde;a <span title="Este campo es obligatorio">*</span></label><div id="err_password" class="help-block with-errors"></div>
                <div class="input-group">
                  <span class="input-group-addon show_hidden" onclick="pass_reveal(this);"><i class="fa fa-eye"></i></span>
