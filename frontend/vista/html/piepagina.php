           ...
           <div class="col-md-6">
            ...
            <div id="area_group">
              ...
              <div class="form-group">
                ...
                <p for="area" class="text-center text_form">Área&nbsp;<i class="requerido">*</i></p><div class="help-block with-errors" id="area_error"></div>
            ...
            <div id="subarea_group">
              <div class="col-md-6">
              <div class="form-group">
                <label>Seleccione área</label>
                <p for="subarea" class="text-center text_form">Subareas&nbsp;<i class="requerido">*</i></p><div class="help-block with-errors" id="area_error"></div>
...
<script type="text/javascript">
  ...
  // if(document.getElementById('panelarea')){

// }
</script>
<script type="text/javascript">
  console.log($('#panelarea').find('li').length);
  $('#panelarea').find('li').on('click', function(){
    console.log("eder");
