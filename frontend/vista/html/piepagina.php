           ...
           <div class="col-md-6">
            ...
            <div class="col-md-6" id="group_num1_contact">
              <div class="form-group">
                ...
                <input type="text" name="tel_one_contact" id="tel_one_contact" class="form-control" onkeydown="return valida_numeros(event);">
              </div>
            </div> 
            ...
            <div class="col-md-6" id="group_num2_contact">
              <div class="form-group">
                ...
                <input type="text" name="tel_two_contact" id="tel_two_contact" class="form-control" onkeydown="return valida_numeros(event);">
              </div>
            </div> 
