    ...
    <div class="container">
      <div class="row">
        <div class="maine_action">
          <div class="col-md-4">
            <div class="action_item text-center"><input type="text" hidden id="puerto_host" value="<?php echo PUERTO."://".HOST ;?>"></div>
          </div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="foot_div_section">
              ...
              <a class="legal_info_content" href="form-g.php">Recomendaciones</a>
