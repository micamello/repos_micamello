...
<div class="caja-postulaciones">
	...
	<div class='panel-body ofertaUrgente' id='caracteristica_oferta'>
		<div class="row">
			...
			<div class="col-md-2">
				<div class="col-md-12 col-sm-2 col-xs-4" style="padding-left: 0px;" align="center">
					<?php 										
			...
			<div class="col-md-10">
				...
				<?php if ($_SESSION['mfo_datos']['usuario']['tipo_usuario'] == Modelo_Usuario::EMPRESA) { ?>
					<div class="col-md-6 col-sm-3">
						<p class="texto-postulaciones"><?php echo strip_tags(html_entity_decode($o['descripcion'])); ?></p>
					</div>
				<?php }else{ ?>

					<?php if($vista == 'postulacion'){ ?>
						<div class="col-md-4 col-sm-3">
		                  <p class="texto-postulaciones">Modo que aplico:<b><?php echo POSTULACIONES[$o['tipo']]; ?></b><br>
				...
				<div class="col-md-<?php if($vista == 'postulacion'){ echo '2'; }else{ echo '3'; } ?> col-xs-4">
				...
				<?php if($vista == 'postulacion'){ ?>
					...
					<div class="col-md-12 col-sm-6 col-xs-12">
	                  <div class="col-md-3 col-sm-3 col-xs-6">
		                  <i class="postulacion-icono <?php if(date("Y-m-d H:i:s", strtotime($o['fecha_contratacion'])) <= date('Y-m-d H:i:s')){ echo 'icono-por-aprobar'; }else{ echo 'icono-aprobado'; } ?> fa fa-calendar"></i><br>
		                  <p id="postulacion-2"><?php if(isset($postulado)){ ?>
							<?php echo date("d-m-Y", strtotime($postulado[0]['fecha_postulado'])); ?>
						  <?php } ?></p>
	                  </div>
	                  <div class="col-md-3 col-sm-3 col-xs-6">
		                  <i class="postulacion-icono <?php if(date("Y-m-d H:i:s", strtotime($o['fecha_contratacion'])) <= date('Y-m-d H:i:s')){ echo 'icono-por-aprobar'; }else{ echo 'icono-aprobado'; } ?> fa fa-spinner"></i><br>
	                  ...
	                  <div class="col-md-3 col-sm-3 col-xs-6">
	                  <i class="postulacion-icono <?php if(date("Y-m-d H:i:s", strtotime($o['fecha_contratacion'])) <= date('Y-m-d H:i:s')){ echo 'icono-por-aprobar'; }else if(isset($cv_descargado) && $cv_descargado['cantd_descarga'] >= 1){ echo 'icono-aprobado'; } ?> fa fa-file"></i><br>
	                  <p id="postulacion-2">CV Visto</p>
	                  </div>
	                  <div class="col-md-3 col-sm-3 col-xs-6">
	                  <i class="postulacion-icono <?php if(date("Y-m-d H:i:s", strtotime($o['fecha_contratacion'])) <= date('Y-m-d H:i:s')){ echo 'icono-por-aprobar'; }else{ echo 'activateicono-aprobado'; } ?> fa fa-check"></i><br>
