<?php
require_once RUTA_INCLUDES.'factura/KeyPairReader.php';
require_once RUTA_INCLUDES.'factura/XmlTools.php';
require_once RUTA_INCLUDES.'factura/FacturaeUtils.php';
...
abstract class FacturaeSignable extends FacturaeUtils {
  ...
  protected function injectSignature($xml) {
    ...
    $prop = '<etsi:SignedProperties Id="Signature' . $this->signatureID .
            '-SignedProperties' . $this->signedPropertiesID . '">' .
    ...
    $sInfo = '<ds:SignedInfo Id="Signature-SignedInfo' . $this->signedInfoID . '">' . "\n" .
               ...
               '</ds:SignatureMethod>' . "\n" .
               '<ds:Reference Id="SignedPropertiesID' . $this->signatureSignedPropertiesID . '" ' .
